...
<template>
  <div class="rounded-xl flex flex-col bg-white px-2 shadow-2xl h-screen w-[300px] m-2">
    ...
    >
    <hr class="px-2 my-4">
    <div class="flex my-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-base font-normal p-2 rounded">
      <svg
        width="24"
        height="24"
    ...
    <div class="flex my-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-base font-normal p-2 rounded mt-auto">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
