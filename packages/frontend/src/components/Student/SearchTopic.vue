...
<template>
  <div class="m-2 flex">
    <div class="relative w-1/3 mt-2 ml-2">
      <select
        id="grid-state"
      ...
      <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700 mb-2">
        <svg
...
<script>
import TableDKMH from './TableDKMH.vue';
